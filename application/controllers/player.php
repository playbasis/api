...
//			'image',
	...
	public function recurGetChildUnder($client_id,$site_id,$parent_node,&$result,&$layer =0, $num = 0){
	...
	public function recurGetChildByLevel($client_id,$site_id,$parent_node,&$result,&$layer =0, $num = 0){
		//array_push($result,$num);
		//array_push($result,$layer);
		if($num++==$layer || $layer==0){
			array_push($result,$parent_node);
	...
	public function getAssociatedNode_get($player_id = '')
	{
		...
		$result = $this->player_model->getAssociatedNodeOfPlayer($this->validToken['client_id'],$this->validToken['site_id'],$pb_player_id);
		$this->response($this->resp->setRespond($result), 200);
	}
	...
	public function getRole_get($player_id = '',$node_id='') {
		...
		$result = $this->player_model->getRoleOfPlayer($this->validToken['client_id'],$this->validToken['site_id'],$pb_player_id,new MongoId($node_id));
	...
	public function saleHistory_get($player_id = '',$count = 6) {
		$result = array();
